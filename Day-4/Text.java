...
public final class Text {
    public static final String TEXT ="Polymorphism is the ability of an object to take on many forms The most common use of polymorphism in " +
    ...
    public static void main(String[] args){
        ...
        //print count unique values count and words
        System.out.println(uniqueWordsFromText.size());
